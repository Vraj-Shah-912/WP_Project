    ...
    <table>
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td style='position: relative;left: 47%;bottom: 65px;font-size: 25px;'><b>Branch :</b>&emsp;" . $row['branch'] . "</td></tr>";
                echo "<tr><td style='position: relative;left: 47%;bottom: 79px;font-size: 25px;'><b>Semester :</b>&emsp;" . $row['sem'] . "</td></tr>";
                echo "<tr><td style='position: relative;left: 47%;bottom: 92px;font-size: 25px;'><b>Class :</b>&emsp;" . $row['class'] . "</td></tr>";
            } else {
